...
function SectionComponent({
  ...
  return (
    ...
    >
      <h2 className="text-primary font-bold text-md">{title}</h2>
      <div>{children}</div>
    </div>
  );
}
      ...
      <div className="max-w-7xl mx-auto flex flex-col">
        ...
        <SectionComponent title="2. Nossos Valores">
          <ul className="list-disc ml-12">
            <li className="text-primary text-md">Agir com integridade</li>
            <li className="text-primary text-md">Busca por Excelência</li>
            <li className="text-primary text-md">
              Atuar como parte integrante da organização
            </li>
            <li className="text-primary text-md">Importar-se com as Pessoas</li>
            <li className="text-primary text-md">Satisfação do Cliente</li>
          </ul>
        </SectionComponent>
