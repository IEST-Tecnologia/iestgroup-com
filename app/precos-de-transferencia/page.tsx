  ...
  return (
    <>
      ...
      >
        ...
        <div className="text-lg text-primary font-base mb-8 text-justify md:text:left md:columns-2 md:gap-12.5 [&>p]:mb-6">
          <p>
      ...
      <section className="w-full bg-[#f5f5f5] py-10 mt-10">
        <div className="max-w-277.75 mx-auto">
          <div className="flex justify-center">
            <h3 className="w-full md:w-3/5 text-blue-iest font-bold text-xl md:text-3xl text-center">
      ...
      <div className="flex flex-col gap-10 my-10">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-blue-iest font-medium text-xl md:text-3xl text-center px-2">
        ...
        <section className="w-full">
          <div className="max-w-7xl mx-auto shadow-card p-7.5">
            <h2 className="text-blue-iest text-lg md:text-2xl font-semibold mb-4 ">
